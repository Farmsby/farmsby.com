<?php
  # Database Configuration
    ...
    defined('DATABASE_USER')    OR define('DATABASE_USER', 'aqquypdh_admin');
    defined('DATABASE_CODE')    OR define('DATABASE_CODE', 'D9f!1s1dl^.Q');
    defined('DATABASE_NAME')    OR define('DATABASE_NAME', 'aqquypdh_farmsby');
  # Permissions
  ...
  # Directory Pathing
    defined('BASEPATH')         OR define('BASEPATH', 'https://farmsby.com/');
