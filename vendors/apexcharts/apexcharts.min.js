                ...
                value: function(A, s) {
                    ...
                    for (var e = function(r, o) {
                            ...
                            for (var S = n.group({
                                    ...
                                    var i;
                                    void 0 === C.series[r][e] || null === A[r][e] ? C.isNullValue = !0 : C.isNullValue = !1, P.config.stroke.show && (k = C.isNullValue ? 0 : Array.isArray(C.strokeWidth) ? C.strokeWidth[b] : C.strokeWidth), i = C.isHorizontal ? C.drawBarPaths({
                                        indexes: {
                                            i: r,
                                            j: e,
                                            realIndex: b,
        ...
        t.exports = function(o) {
            return function(t, e, i) {
                ...
                if (o && e != e) {
                    ...
                    for (; r < n; r++)
                        if ((o || r in s) && s[r] === e) return o || r || 0; return !o && -1
            }
        }
    }, function(t, e, i) {
        "use strict";
            ...
            return a(i, [{
                ...
                value: function(t) {
                    ...
                    for (var x, v, b = u, m = 0; m < r; m++) {
                        l = "hour", 24 <= f && (f = 0, l = "day", g = h(p, g = (x = p += 1, v = g, o.determineDaysOfMonths(v + 1, s) < x && (v += p = 1), {
                            month: v,
                            date: p
                        }).month));
            ...
            return a(i, [{
                ...
                value: function(t) {
                    ...
                    if (null !== i.xaxisTooltip) {
                        ...
                        t -= i.xaxisTooltip.getBoundingClientRect().width / 2, isNaN(t) || (t += e.globals.translateX, a = new n.default(this.ctx).getTextRects(i.xaxisTooltipText.innerHTML), i.xaxisTooltipText.style.minWidth = a.width + "px", i.xaxisTooltip.style.left = t + "px", i.xaxisTooltip.style.top = s + "px")
                    }
                }
            }, {
                ...
                value: function(w, a) {
                    ...
                    for (var A = 0, C = 0, i = function(n, r) {
                            ...
                            for (var e = function(i) {
                                    var t;
                                    S.config.stroke.show && (y = k.isNullValue ? 0 : Array.isArray(k.strokeWidth) ? k.strokeWidth[g] : k.strokeWidth), t = k.isHorizontal ? k.drawBarPaths({
                                        indexes: {
                                            i: n,
                                            j: i,
                                            realIndex: g,
